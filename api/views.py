...
from api.serializer import AccountSerializer, ReceiptSerializer, TransactionSerializer, WalletSerializer
from rest_framework import viewsets
from wallet.models import Customer, Wallet,Account,Card,Transaction,Loan,Receipt,Notifications
from .serializers import CardSerilaizers, CustomerSerializer, NotificationsSerilaizers
...
from rest_framework.response import Response, views
...
# from django.shortcuts import render
# from api.serializer import AccountSerializer, NotificationsSerializer, ReceiptSerializer, TransactionSerializer, WalletSerializer
# from rest_framework import viewsets
# from wallet.models import Account, Card, Customer, Loan, Notifications, Transaction, Wallet
...
#            return response("Account Not Found", status=404)
#        message, status = account.deposit(amount)
#        return ResponseNotReady(message, status=status)
# class AccountWithdrawView(views.APIView):
#    """
#    This class allows withdraw of funds to an account.
#    Accepts this JSON data
...
#            account = Account.objects.get(id=account_id)
#        except ObjectDoesNotExist:
#            return responses("Account Not Found", status=404)
#        message, status = account.withdraw(amount)
#        return ResponseError(message, status=status)
# class AccountTransferView(views.APIView):
#    def post(self, request, format=None):
#        account_id = request.data["account_id"]
#        amount = request.data["amount"]
